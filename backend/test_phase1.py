...
Validates SQLite-based recommendations storage.
"""
...
def test_migration():
    ...
    logger.info(f"✅ Migration result: {migration_result['message']}")
    
    # Validate migration
    validation_result = validate_migration()
    logger.info(f"✅ Validation result: {validation_result['message']}")
    
    return migration_result['success'] and validation_result['success']
